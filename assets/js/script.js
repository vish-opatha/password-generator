...
let pwCombination = []; //numbers,uppercase,lowercase,special characters
...
function getPasswordLength() {
  ...
  console.log('inside getPasswordLength password length', passwordLength);
}
...
function getPasswordCombination() {
  ...
  console.log('inside getPasswordCombination', isNumbersRequired, isUpperCaseRequired, isLowerCaseRequired, isSpecialCharRequired  );
}
...
function generatePasswordCombination(isRequired, index, listOfChars) {
  console.log('inside generatePasswordCombination');
  if(isRequired)
  {
...
function generateFirstChars(aIndex,refArray) {
  console.log('generateFirstChars');
  ...
  console.log('inside generateFirstChars, password', password);
}
...
{
    console.log('inside displayPassword')
    getPasswordLength();
    getPasswordCombination();
    password = '';
    ...
    console.log('========= PW combination', pwCombination);
    console.log('========= PW character array', pwArray);
